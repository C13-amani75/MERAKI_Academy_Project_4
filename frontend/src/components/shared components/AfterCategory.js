...
const AfterCategory = () => {
  return (
    <div className='afterCaregory'>
        <h1 className='title1'>Our Services</h1>
    <div className='.a123' id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
    <h1 className='serviceName a1'>Designing</h1>
    ...
    <div class="carousel-item">
    <h1 className='serviceName a4'>Online Store</h1>
      <img  className='w123' class="d-block w-100 " src="https://res.cloudinary.com/drhlmb3qr/image/upload/v1736432451/pexels-mart-production-7679456_ssmu0u.jpg" alt="Third slide"/>
    </div>
    <div class="carousel-item">
    <h1 className='serviceName a4'>On site Store</h1>
